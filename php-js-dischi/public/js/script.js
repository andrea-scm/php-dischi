...
$(document).ready(function () {
  var url = 'http://localhost:8888/boolean/ex/php-dischi/php-js-dischi/'; //stampa i dischi

  disegnaDischi(url); //filtra i dischi per artista

  $('.search-artist').keyup(function (search) {
    var searchInput = $(this).val().toLowerCase(); //console.log(searchInput);

    var keyCode = search.which; //console.log(keyCode);

    if (keyCode != 32) {
      //in modo che viene omesso lo spazio durante la ricerca,
      ...
      if ((keyCode > 64 && keyCode < 123 || keyCode == 8) && searchInput != '') {
        $('.artist').each(function () {
          ...
          console.log(artistName.indexOf(searchInput)); //console.log(artistName);
  ...
  $('.order').on('change', function () {
    ...
    if ($('.order').val() == 'increasing') {
      //li ordina in modo crescete
      disegnaDischiOrdineCrescente(url);
    } else if ($('.order').val() == 'decreasing') {
      //li ordina in modo decrescete
      disegnaDischiOrdineDecrescente(url);
    } else {
      //altrimenti li mostra di base
      disegnaDischi(url);
    }
  });
});
...
/***/ 0:
/*!***********************************************************!*\
  !*** multi ./src/js/script.js ./src/scss/main_style.scss ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\MAMP\htdocs\boolean\ex\php-dischi\php-js-dischi\src\js\script.js */"./src/js/script.js");
module.exports = __webpack_require__(/*! C:\MAMP\htdocs\boolean\ex\php-dischi\php-js-dischi\src\scss\main_style.scss */"./src/scss/main_style.scss");
